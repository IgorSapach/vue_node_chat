        ...
        <b-card title="Сhat room list" class="mb-2">
          <b-row class="mb-3">
            <b-col class="d-flex justify-content-end">
              <b-button
                variant="danger"
                class="mr-2"
                @click="showDeleteIcons = !showDeleteIcons"
                >Delete room</b-button
              >
              <b-button variant="outline-primary" v-b-modal.adding-room-modal>
                Add room
              </b-button>
            </b-col>
          </b-row>
          <b-row class="d-flex justify-content-center">
            ...
            <b-col v-else cols="10" class="pt-5">
              <h5>
                There are no rooms. Please, if you want to start a
                correspondence, create a room and enter it.
              </h5>
            </b-col>
          </b-row>
        </b-card>
...
<script>
import AddingRoomModal from "../components/AddingRoom";
